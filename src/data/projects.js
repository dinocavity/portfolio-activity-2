const projects = [
    {
      ...
      image: '/assets/images/projects/smart-store-manager.jpg',
      technologies: ['React', 'Python', 'TensorFlow', 'PostgreSQL', 'Django', 'Chart.js'],
      featured: true,
      liveUrl: 'https://example.com/smart-store-manager',
      repoUrl: 'https://github.com/yourusername/smart-store-manager'
    },
    {
      id: 2,
      title: 'Pokedex',
      ...
      repoUrl: 'https://github.com/yourusername/pokedex'
    },
    {
      id: 3,
      title: 'Todo App',
    ...
    },
    {
      ...
      image: '/assets/images/projects/ardeur-de-france.jpg',
      technologies: ['React', 'Node.js', 'PostgreSQL', 'Stripe', 'Tailwind CSS'],
      featured: true,
      liveUrl: 'https://example.com/ardeur-de-france',
      repoUrl: 'https://github.com/yourusername/ardeur-de-france'
    }
  ];
